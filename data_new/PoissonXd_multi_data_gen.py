...
for l in range(len(a)):
    ...
    for i in range(train_size):
        ...
        for d in range(num_dim):
            train_data[l][i][d] = data_random_main[l][k][d] 
        k = k + 1
    train_label[l] =  Poisson_XD_dx(train_data[l],-a[l])

    for i in range(test_size):
        #print(k)
        for d in range(num_dim):
            test_data[l][i][d] = data_random_main[l][k][d] 
        k = k + 1
    test_label[l] =  Poisson_XD_dx(test_data[l],-a[l])

    for i in range(val_size):
        for d in range(num_dim):
            val_data[l][i][d] = data_random_main[l][k][d] 
        k = k + 1
    val_label[l] = Poisson_XD_dx(val_data[l],-a[l]) 
...
for l in range(len(a)):
    ...
    for i in range(train_size_b):
        ...
        k = k + 1
    for d in range(num_dim):
        train_label_b[d][l] = Poisson_XD_dx(train_data_b[d][l],-a[l])
    ...
    for i in range(test_size_b):
        ...
        k = k + 1
    for d in range(num_dim):
        test_label_b[d][l] = Poisson_XD_dx(test_data_b[d][l],-a[l])
    ...
    for i in range(val_size_b):
        ...
        k = k + 1
    for d in range(num_dim):
        val_label_b[d][l] = Poisson_XD_dx(val_data_b[d][l],-a[l])    
    #print(val_data_b)
...
for l in range(len(a)):
    ...
    for i in range(train_size_b):
        ...
        k = k + 1
    for d in range(num_dim):
        train_label_b[num_dim+d][l] = Poisson_XD(train_data_b[num_dim+d][l],a[l])
    ...
    for i in range(test_size_b):
        ...
        k = k + 1
    for d in range(num_dim):
        test_label_b[num_dim+d][l] = Poisson_XD(test_data_b[num_dim+d][l],a[l])
    ...
    for i in range(val_size_b):
        ...
        k = k + 1
    for d in range(num_dim):
        val_label_b[num_dim+d][l] = Poisson_XD(val_data_b[num_dim+d][l],a[l])
...
filename = './poisson' + str(num_dim) + 'D_multi_' + str(a)  + '_5000.mat' # './poisson4D_multi_[10-100].mat'
# filename = 'sims.mat'
