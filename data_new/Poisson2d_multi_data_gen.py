...
for l in range(len(a)):
    ...
    for i in range(train_size):
        ...
        train_label[l][i] = -a[l]*(train_data[l][i][0]**2 - train_data[l][i][0] + train_data[l][i][1]**2 - train_data[l][i][1])    
        k = k + 1
    print(train_data)
    ...
    for i in range(test_size):
        ...
        test_label[l][i] = -a[l]*(test_data[l][i][0]**2 - test_data[l][i][0] + test_data[l][i][1]**2 - test_data[l][i][1])   
        k = k + 1
    print(test_label)
    ...
    for i in range(val_size):
        ...
        val_label[l][i] = -a[l]*(val_data[l][i][0]**2 - val_data[l][i][0] + val_data[l][i][1]**2 - val_data[l][i][1])   
        k = k + 1
    print(val_label)
...
filename = './poisson2D_multi_[10-100].mat'
# filename = 'sims.mat'
