...
parser.add_argument('--data', default='Poisson6D_gridsearch_homogen_new/tt/', help='dateset')
parser.add_argument('--num_quad', type=int, default=20, help='number of quadrature points')
parser.add_argument('--r', type=int, default=6, help='number of quadrature points')
parser.add_argument('--r1', type=int, default=12, help='number of quadrature points')
...
parser.add_argument('--result_folder', type=str, default='Poisson4D_gridsearch_homogen_final/TT-2-1-1/')
...
reg_para1 = [1]
reg_para2 = [1,10] #,0.01,0.0001] # 1e-2,1e-3,1e-4]
epoch = args.epochs
x_dim = 4
qx_dim = 1
r = args.r
...
mlp_quad_last_shape = [[r1,r],[r,r],[r,1]]
quad_concat = [[0,1],[2],[3]]
tensor_quad_dim = [num_quad,num_quad,num_quad,num_quad,num_quad,num_quad]
no_samples = 1
...
#net_config_X_arr.append([x_dim, 128,128,128,128,  r1])
...
#net_config_X_arr.append([x_dim, 256,256,256,256,256,  r1])



net_config_outer_arr1 = list()
net_config_outer_arr1.append([qx_dim+1, 256,256,256,r1*r])
net_config_outer_arr1.append([qx_dim+1, 128,128,128,r1*r])

net_config_outer_arr2 = list()
net_config_outer_arr2.append([qx_dim, 128,128,r*r])
net_config_outer_arr2.append([qx_dim, 64,64,64,r*r])

net_config_outer_arr_last = list()
net_config_outer_arr_last.append([qx_dim, 128,128,r])
...
for p in range(x_dim):
    ...
    q_0 = torch.FloatTensor([0.25]).to(device)
    green_x.append(q_0)
                            ...
                            for reg_p2 in reg_para2:
                                ...
                                for j in range(no_samples):
                                    ...
                                    def train(): #datastr,splitstr):
                                        ...
                                        model = DecGreenNet_product_tensor_sep_w_green(mlp_x,  r_func ,nn_quad_list, mlp_quad_last_shape,quad_concat).to(device)
                                        ...
                                        return error_abs, t # error_relative, t
                                    ...
                                    filename =   args.result_folder   + '_' + str(args.seed)   + '_' + str(lr)     + '_' + str(wd)  + '_' + str(drop)   + '_' + str(reg_p1)   + '_' + str(reg_p2)   + '_' + str(net_config_X)   + '_'   + str(net_config_outer1)  + '_'   + str(net_config_outer2)   + '_'   + str(net_config_outer_last)   + '_'   + str(r)  + '_'   + str(r1)  + '_'   + str(num_quad)  + '_' + str(args.act_type_x) + '_' + str(args.act_type_quad)   + '_' + str(args.act_type_last)  + '_' + str(loss_val)   + '_' + str(error_abs)  + '_' + str(error_abs)  + '_time_' + str(t) + '.mat'
