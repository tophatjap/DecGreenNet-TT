...
parser.add_argument('--hidden', type=int, default=32, help='hidden dimensions.')
parser.add_argument('--dropout', type=float, default=0.5, help='Dropout rate (1 - keep probability).')
parser.add_argument('--patience', type=int, default=100, help='Patience')
parser.add_argument('--data', default='poisson3D_homogenous_', help='dateset')
parser.add_argument('--num_quad', type=int, default=400, help='number of quadrature points')
parser.add_argument('--r', type=int, default=16, help='number of quadrature points')
parser.add_argument('--r1', type=int, default=32, help='number of quadrature points')
...
parser.add_argument('--result_folder', type=str, default='./Poisson4D_gridsearch_homogen_final/TT-2-2/')
...
#net_config_X_arr.append([x_dim, 64,64,64,64,  r1])
#net_config_X_arr.append([x_dim, 1024,1024,1024,  r1])
...
net_config_outer_arr1.append([qx_dim+1, 256,256,256,r1*r])
#net_config_outer_arr1.append([qx_dim+1, 256,256,r1*r])
#net_config_outer_arr1.append([qx_dim+1, 256,256,256,256,r1*r])
#net_config_outer_arr1.append([qx_dim+1, 512,512,r1*r])

#net_config_outer_arr1.append([qx_dim+1, 256,256,r1*r])
#net_config_outer_arr1.append([qx_dim+1, 128,128,r1*r])


net_config_outer_arr2 = list()
net_config_outer_arr2.append([])
#net_config_outer_arr.append([qx_dim, 32,32,32,r*r])
#net_config_outer_arr2.append([qx_dim, 64,64,r])
#net_config_outer_arr2.append([qx_dim, 64,64,64,r])
#net_config_outer_arr2.append([qx_dim, 128,128,r])

net_config_outer_arr_last = list()
#net_config_outer_arr_last.append([qx_dim, 16,16,16,r])
net_config_outer_arr_last.append([qx_dim+1, 128,128,128,r])
#net_config_outer_arr_last.append([qx_dim+1, 128,128,r])
#net_config_outer_arr_last.append([qx_dim+1, 256,256,256,r])
#net_config_outer_arr_last.append([qx_dim+1, 64,64,64,r])



fname = 'data_new/poisson_homogenous4_num_boundaries_32_D_boundary_80000.mat'
...
for net_config_X in net_config_X_arr:
    for net_config_outer1 in net_config_outer_arr1:
        for net_config_outer2 in net_config_outer_arr2:
                            ...
                            for reg_p2 in reg_para2:
                                ...
                                for j in range(no_samples):
                                    ...
                                    def train(): #datastr,splitstr):
                                        ...
                                        for d in range(len_quad_concat-2):
                                            mlp_quad_act2 = activation_ext(act = args.act_type_quad).to(device)
                                            mlp_quad2= nn_mlp_last_na_custom_act_tensor(net_config_outer2, mlp_quad_act2, mlp_quad_last_shape[d+1] ).to(device)
                                        ...
                                        return loss_val, error_abs, t # error_relative, t
                                    ...
                                    filename =   args.result_folder + '_' + str(args.seed)   + '_' + str(lr)     + '_' + str(wd)  + '_' + str(drop)   + '_' + str(reg_p1)   + '_' + str(reg_p2)   + '_' + str(net_config_X)   + '_'   + str(net_config_outer1)  + '_'   + str(net_config_outer2)   + '_'   + str(net_config_outer_last)   + '_'   + str(r)  + '_'   + str(r1)  + '_'   + str(num_quad)  + '_' + str(args.act_type_x) + '_' + str(args.act_type_quad)   + '_' + str(args.act_type_last)   + '_' + str(error_abs)  + '_' + str(error_abs)  + '_time_' + str(t)  + '.mat'
