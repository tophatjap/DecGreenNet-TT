...
parser.add_argument('--epochs', type=int, default=5, help='Number of epochs to train.')#1000
...
net_config_X_arr.append([x_dim, 512,512,512,  r1**2])
net_config_X_arr.append([x_dim, 512,512,512,512,  r1**2])
#net_config_X_arr.append([x_dim, 512,512,  r1])


net_config_outer_arr1 = list()

net_config_outer_arr1.append([1, 32,32,32,r1*r])
net_config_outer_arr1.append([1, 64,64,r1*r])
                                    ...
                                    for quad_ in quads:
                                        ...
                                        for j in range(no_samples):
                                            ...
                                            def train(): #datastr,splitstr):
                                                ...
                                                model = DecGreenNet_product_CP2_non_sep(mlp_x,  r_func ,nn_quad_list, mlp_quad_last_shape,quad_concat).to(device)
